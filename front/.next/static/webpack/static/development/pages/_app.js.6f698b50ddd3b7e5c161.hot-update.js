...
function loadFollowersAPI(userId) {
  ...
  // 서버에 요청을 보내는 부분
  return axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("/user/".concat(userId, "/followers?offset=").concat(offset, "&limit=").concat(limit), {
    withCredentials: true
  });
}
...
function loadFollowingsAPI(userId) {
  ...
  var limit = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 3;
  // 서버에 요청을 보내는 부분
  return axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("/user/".concat(userId, "/followings?offset=").concat(offset, "&limit=").concat(limit), {
    withCredentials: true
  });
}
...
//# sourceMappingURL=_app.js.6f698b50ddd3b7e5c161.hot-update.js.map